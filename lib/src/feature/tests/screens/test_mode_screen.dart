  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: BlocBuilder<TestView, TestViewState>(
      builder: (context, state) {
        ...
        if (detail == null) {
          return const Center(
            child: Padding(padding: EdgeInsets.symmetric(vertical: 24), child: CircularProgressIndicator.adaptive()),
          );
        }
        ...
        return ListView(
          ...
          children: [
            TestDescriptionWidget(test: testModel, onPressLike: onPressLike, onPressShare: onPressShare),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            FilledButton(
                              onPressed: () => context.read<TestView>().getAttempts(widget.testId),
