...
class SettingsScope extends StatefulWidget {
  ...
  static SettingsBloc of(BuildContext context, {bool listen = true}) =>
      context.x.inhOf<_InheritedSettings>(listen: listen).state._settingsBloc;

  /// Get the [AppSettings] instance.
  static AppSettings settingsOf(BuildContext context, {bool listen = true}) =>
      context.x.inhOf<_InheritedSettings>(listen: listen).settings;
...
class _SettingsScopeState extends State<SettingsScope> {
  ...
  void initState() {
    super.initState();
    _settingsBloc = context.x.dependencies.settingsBloc;
  }
