...
void main(List<String> args) async {
  ...
  final assetsDirectory = Directory('packages/ui/lib/');
  final vecDirectory = Directory('packages/ui/lib/$vectorFileName');
  ...
  final existingVecFiles = Set<String>.from(
    vecDirectory.listSync().map((e) => e.path.split('.').firstOrNull?.split('/').lastOrNull),
  );
