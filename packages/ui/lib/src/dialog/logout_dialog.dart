    ...
    child: Stack(
      children: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    title,
                    style: context.x.textStyle.sfW700s28.copyWith(fontSize: 24, color: context.x.colors.error),
                      ...
                      Expanded(
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            ...
                            backgroundColor: context.x.colors.error,
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                            padding: const EdgeInsets.all(14),
                            fixedSize: const Size(double.infinity, 50),
                          ),
        ...
        Positioned(
          ...
          left: 0,
          right: 0,
          child: Assets.lib.images.logoutQuizbot.image(width: 144, height: 144, package: 'ui'),
        ),
      ],
    ),
  );
