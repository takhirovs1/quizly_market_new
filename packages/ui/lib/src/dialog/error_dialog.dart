    ...
    child: Stack(
      children: [
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    title,
                    style: context.x.textStyle.w700s28.copyWith(fontSize: 24, color: context.x.colors.error),
        ...
        Positioned(
          ...
          left: 0,
          right: 0,
          child: Assets.lib.vectors.errorDialog.svg(width: 124, height: 124, package: 'ui'),
        ),
      ],
    ),
  );
